	...
	Utils.server.scheduleInTicks(100, () => {
		...
		Utils.server.scheduleInTicks(100, () => {
			...
			Utils.server.scheduleInTicks(80, () => {
				event.server.tell('§5<§kffffffff§r§5>: §eТы обречён §dсемью проклятиями.§r §9Это - испытание твоей жизни. §eОНИ выбрали тебя!§r §6Если ты сможешь пройти это испытание и освободить этот мир от проклятий, ты получишь §aблагословения§r §6до конца своих времён. §3Но сможешь ли ты это сделать?§r §2Всё зависит только от тебя. Сделай правильный выбор!§r §aИ учти: вместе с семью проклятиями ты обретёшь и семь благословений, которые помогут тебе.§r §dСвои проклятия ты узришь взглянув на кольцо, которое у тебя на пальце. Отныне я буду твоим проводником по этому миру.')
...
FTBQuestsEvents.completed('6040F23877065BB0', event => {
	event.server.tell('§5<А§kfffffff§r§5>: Ты нашлёл дом бывшего с`пелеолога, который наслушался легенд о прекрасных шахтах. Таких было много тысяча, две, может три не знаю. Но тебе нужно найти неразгаданное: шифр первобытности - жёлтую пещерную табличку.')
});
//Продолжить дело...
